...
class VetCareTest {
    ...
    // 1) Inserimento valido: proprietario e animale vengono salvati correttamente e
    // sono ricercabili
    // 2) Parametri non validi (nome null, microchip <= 0): confermaRegistrazione
    // non salva nulla, ritorna null
    @org.junit.jupiter.api.Test
